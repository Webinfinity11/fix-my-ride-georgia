// Script to generate full sitemap with all services
import fs from 'fs';
import { createClient } from '@supabase/supabase-js';

const SUPABASE_URL = "https://kwozniwtygkdoagjegom.supabase.co";
const SUPABASE_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imt3b3puaXd0eWdrZG9hZ2plZ29tIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDc4Mzk3MjIsImV4cCI6MjA2MzQxNTcyMn0.hc51a_SvwYNUWfPmm2D3rriqGmE8LecInNmu5fa3tGk";
...
${serviceUrls.join('\n')}
  ...
  <!-- Service links auto-updated: ${currentDate} -->
    ...
    console.log(`Successfully generated sitemap with ${services.length} services!`);
