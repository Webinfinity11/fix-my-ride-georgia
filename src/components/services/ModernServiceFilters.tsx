          ...
          <Collapsible open={showAdvanced} onOpenChange={setShowAdvanced}>
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              <CollapsibleTrigger asChild>
                <Button
                  variant="outline"
                  className="border-primary/20 hover:bg-primary/5 h-12 w-full sm:w-auto"
                >
              ...
              {hasActiveFilters && (
                <Button
                  ...
                  size="sm"
                  className="text-muted-foreground hover:text-destructive border-destructive/20 h-12 w-full sm:w-auto"
                >
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 gap-2 sm:grid-cols-2 lg:grid-cols-3">
                    {commonCarBrands.slice(0, 6).map(brand => (
                      <div key={brand} className="flex items-center space-x-3 p-3 rounded-lg border bg-white min-h-[48px]">
                        <Checkbox
                          id={`brand-${brand}`}
