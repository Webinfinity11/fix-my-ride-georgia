...
const Insurance = () => {
  ...
  const benefits = [
    {
      icon: Shield,
      title: "სრული დაცვა",
      description: "ყოველმხრივი დაზღვევა თქვენი ავტომობილისთვის",
    },
    {
      icon: TrendingDown,
      title: "ოპტიმალური ფასები",
      description: "საუკეთესო ფასები ბაზარზე",
    },
    {
      icon: Zap,
      title: "სწრაფი რეგისტრაცია",
      description: "დაზღვევის გაფორმება 1 დღეში",
    },
    {
      icon: Award,
      title: "წამყვანი კომპანიები",
      description: "ვთანამშრომლობთ ტოპ სადაზღვევო კომპანიებთან",
    },
  ];
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-gray-50 via-white to-blue-50 pb-[70px] md:pb-0">
      <SEOHead
        title={generateSEOTitle('insurance', {})}
        description={generateSEODescription('insurance', {})}
        keywords="ავტოდაზღვევა, მანქანის დაზღვევა, ავტომობილის დაზღვევა, საქართველო, თბილისი, კასკო"
        url={canonicalUrl}
      ...
      <BreadcrumbSchema
        items={[
          ...
          { name: 'დაზღვევა', url: canonicalUrl },
        ]}
      />
      ...
      <main className="flex-grow">
        ...
        <section className="relative py-16 lg:py-24 overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            {/* Service Navigation */}
            <div>
              <ServicePageNavigation currentPage="insurance" />
            </div>
            ...
            <div className="flex flex-col gap-12">
              ...
              <div>
                <LeadForm
                  leadType="insurance"
                  title="დატოვეთ განაცხადი დაზღვევაზე"
                  description="შეავსეთ ფორმა და მიიღეთ საუკეთესო შეთავაზება დაზღვევის კომპანიებიდან"
                />
              </div>
