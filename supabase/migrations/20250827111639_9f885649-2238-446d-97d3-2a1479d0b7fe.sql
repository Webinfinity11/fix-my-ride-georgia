...
CREATE TABLE public.laundries (
  id INTEGER NOT NULL DEFAULT nextval('laundries_id_seq'::regclass) PRIMARY KEY,
  name TEXT NOT NULL,
  description TEXT,
  contact_number TEXT,
  address TEXT,
...
-- Create sequence for laundries table
CREATE SEQUENCE IF NOT EXISTS laundries_id_seq OWNED BY public.laundries.id;
